  ...
  <section class="project-me">
    ...
    <div class="wrapper-grid">
      ...
      <div class="project-container">
        ...
        />
        <h1>Weather App</h1>
        <h1 class="project-overline">Featured Project</h1>

        <div class="description-container">
          <p class="description">
            Weather app develop with vuejs. An API is pass from openweather
            site. You can search any country of your choice from the weather app
            and it will tell you the country tempeature, date, time & atmosphere
        ...
        <div class="project-links">
          <a
            href="https://github.com/dicethedev"
            target="_blank"
            rel="noreferrer"
          >
            <img src="@/assets/github.svg" alt="" />
          </a>
          <!-- Locate the project here -->
          <a
            href="https://weatherappbyblessing.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
            <img src="@/assets/linkto.svg" alt="" />
          </a>
        </div>
      </div>
      <!-- Project 2 -->
